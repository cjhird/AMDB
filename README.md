...
As for myself, my contributions to the project were in the development of the user authentication system build both the backend and also part of the frontend auth along with teamwork from Fasai and Ridwan. I also worked individually on the user watchlist functionality and developed the feature writing both the backend and frontend code.
